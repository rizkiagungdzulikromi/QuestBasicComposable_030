package com.example.questbasiccomposable_030
...
import com.example.questbasiccomposable_030.ui.theme.QuestBasicComposable_030Theme
...
fun BasicComposable(modifier: Modifier = Modifier){
    Column(
        ...
        Text(text = "20220140030", modifier = Modifier,
            fontSize = 50.sp,
            color = Color.Black,
            fontWeight = FontWeight.Bold
        )
